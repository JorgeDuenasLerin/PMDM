...
public class AdaptadorPreguntas extends RecyclerView.Adapter<AdaptadorPreguntas.ViewHolder> {
    ...
    private AdaptadorPreguntas.ItemClickListener mClickListener;

    // data is passed into the constructor
    AdaptadorPreguntas(Context context) {
    ...
    @Override
    public void onBindViewHolder(AdaptadorPreguntas.ViewHolder holder, int position) {
    ...
    void setClickListener(AdaptadorPreguntas.ItemClickListener itemClickListener) {
